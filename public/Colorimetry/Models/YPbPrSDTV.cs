...
namespace Colorimetry.Models
{
    ...
    /// </summary>
    [DebuggerDisplay("YPbPrSDTV = {Y};{Pb};{Pr}")]
    public class YPbPrSDTV : BaseColorModel, IEquatable<YPbPrSDTV>
    {
        /// <summary>
        ...
        public static new bool IsSpecifierValid(string specifier, bool checkParts = false) =>
            specifier.Contains(";") &&
            specifier.StartsWith("ypbprsdtv:") &&
        ...
        /// <summary>
        /// Parses the specifier and returns an instance of <see cref="YPbPrSDTV"/> converted to <see cref="RedGreenBlue"/>
        /// </summary>
        ...
        /// <summary>
        /// Parses the specifier and returns an instance of <see cref="YPbPrSDTV"/>
        /// </summary>
        /// <param name="specifier">Specifier of YPbPr</param>
        /// <returns>An instance of <see cref="YPbPrSDTV"/></returns>
        /// <exception cref="ColorException"></exception>
        ...
        public override bool Equals(object obj) =>
            Equals((YPbPrSDTV)obj);

        /// <inheritdoc/>
        public bool Equals(YPbPrSDTV other) =>
            other is not null &&
            Y == other.Y &&
            Pb == other.Pb &&
            Pr == other.Pr;
        ...
        /// <inheritdoc/>
        public static bool operator ==(YPbPrSDTV left, YPbPrSDTV right) =>
            EqualityComparer<YPbPrSDTV>.Default.Equals(left, right);

        /// <inheritdoc/>
        public static bool operator !=(YPbPrSDTV left, YPbPrSDTV right) =>
            !(left == right);

        internal YPbPrSDTV(double y, double pb, double pr)
        {
            Y = y;
            Pb = pb;
            Pr = pr;
