...
namespace Colorimetry
{
    ...
    public class Color : IEquatable<Color>
    {
        ...
        internal string? vtSeqForeground = null;
        internal string? vtSeqBackground = null;
        internal string? vtSeqForegroundTrue = null;
        internal string? vtSeqBackgroundTrue = null;
