...
using OurColor = Colorimetry.Color;

namespace Colorimetry.Interop
{
    /// <summary>
    /// Provides you with tools to convert <see cref="DrawingColor">System.Drawing's Color</see> to and from <see cref="OurColor">Colorimetry's Color</see>
    /// </summary>
    public static class SystemColorConverter
    {
        /// <summary>
        /// Converts from <see cref="DrawingColor">System.Drawing's Color</see> to <see cref="OurColor">Colorimetry's Color</see>
        /// </summary>
        /// <param name="drawingColor">System.Drawing's Color</param>
        /// <param name="settings">Settings to use</param>
        /// <returns>Colorimetry's Color</returns>
        public static OurColor FromDrawingColor(DrawingColor drawingColor, ColorSettings? settings = null)
        {
            ...
            // Now, get the Drawing's RGB component and convert that to Colorimetry's Color.
        ...
        /// <summary>
        /// Converts from <see cref="OurColor">Colorimetry's Color</see> to <see cref="DrawingColor">System.Drawing's Color</see>
        /// </summary>
        /// <param name="ourColor">Colorimetry's Color</param>
