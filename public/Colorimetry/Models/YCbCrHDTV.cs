...
namespace Colorimetry.Models
{
    ...
    /// </summary>
    [DebuggerDisplay("YCbCrHDTV = {Y};{Cb};{Cr}")]
    public class YCbCrHDTV : BaseColorModel, IEquatable<YCbCrHDTV>
    {
        /// <summary>
        /// The Y value [16 -> 235]
        /// </summary>
        ...
        public static new bool IsSpecifierValid(string specifier, bool checkParts = false) =>
            specifier.Contains(";") &&
            specifier.StartsWith("ycbcrhdtv:") &&
        ...
        /// <summary>
        /// Parses the specifier and returns an instance of <see cref="YCbCrHDTV"/> converted to <see cref="RedGreenBlue"/>
        /// </summary>
        ...
        /// <summary>
        /// Parses the specifier and returns an instance of <see cref="YCbCrHDTV"/>
        /// </summary>
        /// <param name="specifier">Specifier of YCbCr</param>
        /// <returns>An instance of <see cref="YCbCrHDTV"/></returns>
        /// <exception cref="ColorException"></exception>
        public static YCbCrHDTV ParseSpecifier(string specifier)
        {
            if (!IsSpecifierValid(specifier))
                throw new ColorException(LanguageTools.GetLocalized("COLORIMETRY_MODEL_EXCEPTION_PARSEINVALIDYCBCRSPECIFIER").FormatString(specifier) + ": ycbcrhdtv:<y>;<cb>;<cr>");
            ...
            if (specifierArray.Length == 3)
            {
                ...
                var YCbCr = new YCbCrHDTV(y, cb, cr);
                return YCbCr;
            }
            else
                throw new ColorException(LanguageTools.GetLocalized("COLORIMETRY_MODEL_EXCEPTION_PARSEINVALIDYCBCRSPECIFIEREXCEED").FormatString(specifier) + ": ycbcrhdtv:<y>;<cb>;<cr>");
        }

        /// <inheritdoc/>
        public override bool Equals(object obj) =>
            Equals((YCbCrHDTV)obj);

        /// <inheritdoc/>
        public bool Equals(YCbCrHDTV other) =>
            other is not null &&
            Y == other.Y &&
            Cb == other.Cb &&
            Cr == other.Cr;
        ...
        /// <inheritdoc/>
        public static bool operator ==(YCbCrHDTV left, YCbCrHDTV right) =>
            EqualityComparer<YCbCrHDTV>.Default.Equals(left, right);

        /// <inheritdoc/>
        public static bool operator !=(YCbCrHDTV left, YCbCrHDTV right) =>
            !(left == right);

        internal YCbCrHDTV(double y, double cb, double pr)
        {
            Y = y;
            Cb = cb;
            Cr = pr;
