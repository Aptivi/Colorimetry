...
namespace Colorimetry.Models
{
    ...
    /// </summary>
    [DebuggerDisplay("YCbCrSDTV = {Y};{Cb};{Cr}")]
    public class YCbCrSDTV : BaseColorModel, IEquatable<YCbCrSDTV>
    {
        /// <summary>
        /// The Y value [16 -> 235]
        /// </summary>
        ...
        public static new bool IsSpecifierValid(string specifier, bool checkParts = false) =>
            specifier.Contains(";") &&
            specifier.StartsWith("ycbcrsdtv:") &&
        ...
        /// <summary>
        /// Parses the specifier and returns an instance of <see cref="YCbCrSDTV"/> converted to <see cref="RedGreenBlue"/>
        /// </summary>
        ...
        /// <summary>
        /// Parses the specifier and returns an instance of <see cref="YCbCrSDTV"/>
        /// </summary>
        /// <param name="specifier">Specifier of YCbCr</param>
        /// <returns>An instance of <see cref="YCbCrSDTV"/></returns>
        /// <exception cref="ColorException"></exception>
        public static YCbCrSDTV ParseSpecifier(string specifier)
        {
            if (!IsSpecifierValid(specifier))
                throw new ColorException(LanguageTools.GetLocalized("COLORIMETRY_MODEL_EXCEPTION_PARSEINVALIDYCBCRSPECIFIER").FormatString(specifier) + ": ycbcrsdtv:<y>;<cb>;<cr>");
            ...
            if (specifierArray.Length == 3)
            {
                ...
                var YCbCr = new YCbCrSDTV(y, cb, cr);
                return YCbCr;
            }
            else
                throw new ColorException(LanguageTools.GetLocalized("COLORIMETRY_MODEL_EXCEPTION_PARSEINVALIDYCBCRSPECIFIEREXCEED").FormatString(specifier) + ": ycbcrsdtv:<y>;<cb>;<cr>");
        }

        /// <inheritdoc/>
        public override bool Equals(object obj) =>
            Equals((YCbCrSDTV)obj);

        /// <inheritdoc/>
        public bool Equals(YCbCrSDTV other) =>
            other is not null &&
            Y == other.Y &&
            Cb == other.Cb &&
            Cr == other.Cr;
        ...
        /// <inheritdoc/>
        public static bool operator ==(YCbCrSDTV left, YCbCrSDTV right) =>
            EqualityComparer<YCbCrSDTV>.Default.Equals(left, right);

        /// <inheritdoc/>
        public static bool operator !=(YCbCrSDTV left, YCbCrSDTV right) =>
            !(left == right);

        internal YCbCrSDTV(double y, double cb, double pr)
        {
            Y = y;
            Cb = cb;
            Cr = pr;
