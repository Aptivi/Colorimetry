...
namespace Colorimetry.Models
{
    ...
    /// </summary>
    [DebuggerDisplay("YPbPrHiVi = {Y};{Pb};{Pr}")]
    public class YPbPrHiVi : BaseColorModel, IEquatable<YPbPrHiVi>
    {
        /// <summary>
        ...
        public static new bool IsSpecifierValid(string specifier, bool checkParts = false) =>
            specifier.Contains(";") &&
            specifier.StartsWith("ypbprhivi:") &&
        ...
        /// <summary>
        /// Parses the specifier and returns an instance of <see cref="YPbPrHiVi"/> converted to <see cref="RedGreenBlue"/>
        /// </summary>
        ...
        /// <summary>
        /// Parses the specifier and returns an instance of <see cref="YPbPrHiVi"/>
        /// </summary>
        /// <param name="specifier">Specifier of YPbPr</param>
        /// <returns>An instance of <see cref="YPbPrHiVi"/></returns>
        /// <exception cref="ColorException"></exception>
        public static YPbPrHiVi ParseSpecifier(string specifier)
        {
            ...
            if (!IsSpecifierValid(specifier))
                throw new ColorException(LanguageTools.GetLocalized("COLORIMETRY_MODEL_EXCEPTION_PARSEINVALIDYPBPRSPECIFIER").FormatString(specifier) + ": ypbprhivi:<y>;<pb>;<pr>");
            ...
            if (specifierArray.Length == 3)
            {
                ...
                throw new ColorException(LanguageTools.GetLocalized("COLORIMETRY_MODEL_EXCEPTION_PARSEINVALIDYPBPRSPECIFIEREXCEED").FormatString(specifier) + ": ypbprhivi:<y>;<pb>;<pr>");
        }

        /// <inheritdoc/>
        public override bool Equals(object obj) =>
            Equals((YPbPrHiVi)obj);

        /// <inheritdoc/>
        public bool Equals(YPbPrHiVi other) =>
            other is not null &&
            Y == other.Y &&
            Pb == other.Pb &&
            Pr == other.Pr;
        ...
        /// <inheritdoc/>
        public static bool operator ==(YPbPrHiVi left, YPbPrHiVi right) =>
            EqualityComparer<YPbPrHiVi>.Default.Equals(left, right);

        /// <inheritdoc/>
        public static bool operator !=(YPbPrHiVi left, YPbPrHiVi right) =>
            !(left == right);

        internal YPbPrHiVi(double y, double pb, double pr)
        {
            Y = y;
            Pb = pb;
            Pr = pr;
